...
var reviewSwiper = document.querySelector('.review__swiper');
  ...
  if (trainersSwiper) {
    (function () {
      return new _swiper.default('.trainers__swiper', {
        ...
        on: {
          init: function init() {
            var duplicateElements = trainersSwiper.querySelectorAll('.swiper-slide-duplicate');
            duplicateElements.forEach(function (item) {
